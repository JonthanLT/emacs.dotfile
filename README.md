...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/JonthanLT/emacs.dotfile/master/install.sh)"
```

## Via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/JonthanLT/emacs.dotfile/master/install.sh -O -)"
```
